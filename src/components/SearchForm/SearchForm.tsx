...
const SearchForm: React.FC<SearchFormProps> = ({ LabelContent, spanContent }): JSX.Element => {
    return (
        <form className="c-searchform" role="search" method="get" action="https://carleton.ca">
            <label htmlFor="searchform__input">{LabelContent}</label>
            ...
            <button type="submit" title="Search">
                ...
                <span className="u-visually-hidden">{spanContent}</span>
            </button>
        </form>
    )
}
