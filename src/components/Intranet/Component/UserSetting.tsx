...
const UserSettings: React.FC<IUserSettings> = (): JSX.Element => {
        ...
        personal: {
            ...
            content: (
                <div className='u-margin-auto'>
                    ...
                    voluptate amet et. Cillum aliqua nostrud et sit irure nulla
                    dolor deserunt ullamco est pariatur cillum ad. Incididunt
                    quis culpa dolore cillum proident exercitation est eiusmod
                    minim labore et. Esse laborum pariatur amet cillum eu duis
                    in aute fugiat et et proident. Excepteur esse voluptate
                    veniam velit fugiat minim laboris. Duis tempor ullamco
                    pariatur pariatur est aute eu cupidatat eu ea qui do. Ut
                    quis aute laborum mollit labore sint est ullamco veniam
                    cillum irure reprehenderit sit elit. Anim officia sunt velit
                    aute incididunt aute voluptate officia quis commodo proident
                    ex do mollit. Consectetur magna non magna ea sit irure.
                    Proident veniam ipsum proident consectetur minim id esse.
                    Excepteur enim exercitation commodo est cillum excepteur
                    enim anim cupidatat amet eiusmod magna. Ex tempor et qui
                    ullamco occaecat sunt dolore enim minim do. Nostrud dolore
                    labore aliqua est mollit ullamco fugiat commodo sint. Ea
                    exercitation occaecat nisi laborum nisi nulla culpa nisi.
                    Esse nostrud nisi et mollit pariatur labore sint Lorem
                    dolore. Velit Lorem pariatur duis velit magna culpa sit
                    deserunt incididunt sint commodo velit pariatur id. Laborum
    ...
    return (
        ...
        //             <Ugrid columns={1} className='UserSettingsContent'>
